...
read_files=("measurements/4.4_log1.txt" "measurements/4.4_log2.txt" "measurements/4.4_log3.txt")
...
for i in {1..3}
do
    data_file="measurements/4.4_tails${i}.txt"
    csv_filename="4_4_p95_QPS_${i}.csv"
