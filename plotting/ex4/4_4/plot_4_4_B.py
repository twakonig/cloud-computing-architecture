...
def main():
    ...
    ax[1].step(np.append(x_jumps_norm, 840), np.append(y_jumps, 2), where='post', color='darkblue', marker='o', mec='white', mew=0.7, ms=4.0, linewidth=0.6, label='core usage change')
    ax2.plot(x_vals, qps[0:84, R-1], color='grey', marker='h', mec='white', mew=0.7, ms=4.5, linewidth=1.5, label='QPS', alpha=0.7)
    ...
    plt.tight_layout()
    plt.savefig('plot_4_4_B_' + str(R) + '.pdf')
