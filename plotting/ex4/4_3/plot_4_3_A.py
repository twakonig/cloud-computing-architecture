...
def format_plot(ax1, ax2):
    ...
    ax1.set_yticks(np.arange(0, 1.2, 0.1), labels=None, minor=True)
...
def main():
    ...
    ax[1].plot(x_vals, latencies[0:87, R-1], color='royalblue', marker='o', mec='white', mew=0.7, ms=4.5, linewidth=1.5, label='latency')
    ...
    plt.tight_layout()
    plt.savefig('plot_4_3_A_' + str(R) + '.pdf')
